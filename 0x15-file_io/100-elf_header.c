...
/**
 * pRt_magic - Prints the magic numbers of an ELF header.
 * @e_ident: A pointer to an array containing the ELF magic numbers.
 *
...
/**
 * pRt_class - Prints the class of an ELF header.
...
/**
 * pRt_version - Prints the version of an ELF header.
...
/**
 * pRt_osabi - Prints the OS/ABI of an ELF header.
 * @e_ident: A pointer to an array containing the ELF version.
 */
void pRt_osabi(unsigned char *e_ident)
{
...
/**
 * pRt_abi - Prints the ABI version of an ELF header.
...
/**
 * pRt_type - Prints the type of an ELF header.
 * @e_type: The ELF type.
 * @e_ident: A pointer to an array containing the ELF class.
 */
void pRt_type(unsigned int e_type, unsigned char *e_ident)
...
/**
 * pRt_entry - Prints the entry point of an ELF header.
